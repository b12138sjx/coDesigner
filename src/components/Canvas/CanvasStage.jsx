    ...
    case 'title_block':
      return [
        ...
        },
        {
          ...
          x: center.x - 220,
          y: center.y + 26,
          props: { geo: 'rectangle', w: 520, h: 86, text: '鍐呭璇存槑鍖哄潡' },
        },
      ]
    case 'nav_bar':
      return [
        {
          ...
          x: center.x - 380,
          y: center.y - 44,
          props: { geo: 'rectangle', w: 760, h: 88, text: '瀵艰埅瀹瑰櫒' },
        },
        { id: createShapeId(), type: 'text', x: center.x - 340, y: center.y - 8, props: { text: 'Logo' } },
        { id: createShapeId(), type: 'text', x: center.x - 120, y: center.y - 8, props: { text: '棣栭〉' } },
        { id: createShapeId(), type: 'text', x: center.x - 20, y: center.y - 8, props: { text: '鍔熻兘' } },
        { id: createShapeId(), type: 'text', x: center.x + 80, y: center.y - 8, props: { text: '鏂囨。' } },
        { id: createShapeId(), type: 'text', x: center.x + 300, y: center.y - 8, props: { text: '鐧诲綍' } },
      ]
    case 'hero_banner':
      return [
        {
        ...
        },
        {
          ...
          x: center.x - 200,
          y: center.y + 12,
          props: { geo: 'rectangle', w: 140, h: 46, text: '鏌ョ湅婕旂ず' },
        },
      ]
      ...
      return [
        {
          ...
          x: center.x - 460,
          y: center.y - 210,
          props: { geo: 'rectangle', w: 920, h: 420, text: '椤甸潰瀹瑰櫒' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x - 440,
          y: center.y - 190,
          props: { geo: 'rectangle', w: 220, h: 380, text: '渚ф爮瀵艰埅' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x - 200,
          y: center.y - 190,
          props: { geo: 'rectangle', w: 640, h: 80, text: '鍐呭澶撮儴 / 绛涢€夊尯' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x - 200,
          y: center.y - 92,
          props: { geo: 'rectangle', w: 640, h: 282, text: '涓诲唴瀹瑰尯' },
        },
      ]
    case 'button_group':
      return [
        ...
        },
        {
          ...
          x: center.x + 70,
          y: center.y - 24,
          props: { geo: 'rectangle', w: 120, h: 48, text: '骞界伒鎸夐挳' },
        },
      ]
    case 'form_block':
      return [
        { id: createShapeId(), type: 'text', x: center.x - 220, y: center.y - 96, props: { text: '鐧诲綍琛ㄥ崟' } },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x - 220,
        ...
        },
        {
          ...
          x: center.x - 220,
          y: center.y + 92,
          props: { geo: 'rectangle', w: 440, h: 52, text: '鎻愪氦鎸夐挳' },
        },
      ]
    case 'card_list':
      return [
        {
          ...
          x: center.x - 340,
          y: center.y - 80,
          props: { geo: 'rectangle', w: 200, h: 220, text: '鍗＄墖 A' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x - 100,
          y: center.y - 80,
          props: { geo: 'rectangle', w: 200, h: 220, text: '鍗＄墖 B' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x + 140,
          y: center.y - 80,
          props: { geo: 'rectangle', w: 200, h: 220, text: '鍗＄墖 C' },
        },
      ]
    case 'table_block':
      return [
        {
          ...
          x: center.x - 420,
          y: center.y - 150,
          props: { geo: 'rectangle', w: 840, h: 54, text: '琛ㄥご锛氬悕绉?| 鐘舵€?| 璐熻矗浜?| 鏇存柊鏃堕棿' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x - 420,
          y: center.y - 84,
          props: { geo: 'rectangle', w: 840, h: 62, text: '琛?1' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x - 420,
          y: center.y - 10,
          props: { geo: 'rectangle', w: 840, h: 62, text: '琛?2' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x - 420,
          y: center.y + 64,
          props: { geo: 'rectangle', w: 840, h: 62, text: '琛?3' },
        },
      ]
    case 'stats_cards':
      return [
        {
          ...
          x: center.x - 350,
          y: center.y - 80,
          props: { geo: 'rectangle', w: 220, h: 160, text: '鎸囨爣 A\n1,284' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x - 110,
          y: center.y - 80,
          props: { geo: 'rectangle', w: 220, h: 160, text: '鎸囨爣 B\n87%' },
        },
        {
          id: createShapeId(),
          type: 'geo',
          x: center.x + 130,
          y: center.y - 80,
          props: { geo: 'rectangle', w: 220, h: 160, text: '鎸囨爣 C\n36' },
        },
      ]
    default:
      return []
  ...
  return [
    {
      ...
      x: center.x - 1260,
      y: center.y - 420,
      props: { w: 900, h: 760, name: '骞冲彴鍏ュ彛娴佽浆绀轰緥' },
    },
    {
      id: createShapeId(),
      type: 'geo',
      ...
      x: 20,
      y: 20,
      props: { geo: 'rectangle', w: 860, h: 64, text: 'CoDesigner - 鐧诲綍 / 娉ㄥ唽 / 娓稿杩涘叆' },
    },
    {
      id: createShapeId(),
      type: 'geo',
      ...
      x: 20,
      y: 108,
      props: { geo: 'rectangle', w: 410, h: 230, text: '鐧诲綍鍗＄墖\n璐﹀彿杈撳叆\n瀵嗙爜杈撳叆\n鐧诲綍鎸夐挳' },
    },
    {
      id: createShapeId(),
      type: 'geo',
      ...
      x: 450,
      y: 108,
      props: { geo: 'rectangle', w: 430, h: 230, text: '娉ㄥ唽鍗＄墖\n鏄电О\n閭\n瀵嗙爜\n娉ㄥ唽鎸夐挳' },
    },
    {
      id: createShapeId(),
      type: 'geo',
      ...
      x: 20,
      y: 358,
      props: { geo: 'rectangle', w: 860, h: 86, text: '娓稿妯″紡鍏ュ彛锛堣烦杩囩櫥褰曪級' },
    },
    {
      id: createShapeId(),
      type: 'geo',
      ...
      x: 20,
      y: 464,
      props: { geo: 'rectangle', w: 860, h: 266, text: '椤圭洰棣栭〉\n- 椤圭洰鍒楄〃\n- 鏂板缓椤圭洰锛堝垱寤哄悗浠嶅仠鐣欏湪棣栭〉锛塡n- 鐐瑰嚮椤圭洰鍚庡啀杩涘叆妯″潡' },
    },
    {
      id: workspaceFrameId,
      type: 'frame',
      x: center.x - 240,
      y: center.y - 420,
      props: { w: 1520, h: 900, name: '椤圭洰宸ヤ綔鍖虹ず渚嬶紙浣庝繚鐪燂級' },
    },
    {
      id: createShapeId(),
      type: 'geo',
      ...
      x: 0,
      y: 0,
      props: { geo: 'rectangle', w: 1520, h: 72, text: '椤堕儴鏍忥細椤圭洰鍚?/ 澶滈棿鏃ラ棿鍒囨崲 / 褰撳墠鐢ㄦ埛' },
    },
    {
      id: createShapeId(),
      type: 'geo',
      ...
      x: 0,
      y: 72,
      props: { geo: 'rectangle', w: 260, h: 828, text: '宸︿晶瀵艰埅\n椤圭洰棣栭〉\n褰撳墠椤圭洰\n- 鐢诲竷璁捐\n- 鏅鸿兘鏂囨。\n- 鎺ュ彛鍗忓悓' },
    },
    {
      id: createShapeId(),
      type: 'geo',
    ...
    },
    {
      ...
      x: 560,
      y: 218,
      props: { geo: 'rectangle', w: 520, h: 660, text: '鐧芥澘鐢诲竷\n鎷栨嫿鎻掑叆浣庝繚鐪熺粍浠禱n鏀寔澶氶€夌缉鏀句笌缁勫悎' },
    },
    {
      id: createShapeId(),
      type: 'geo',
      ...
      x: 1100,
      y: 218,
      props: { geo: 'rectangle', w: 180, h: 660, text: '鍙充晶灞炴€ч潰鏉匡紙鍙姌鍙狅級\n宸ュ叿\n缂╂斁\n鎻愮ず' },
    },
    {
      id: createShapeId(),
      type: 'geo',
...
/**
 * 鍩轰簬 tldraw 鐨勭敾甯冿細鏀寔缁樺埗銆佸舰鐘躲€佹枃鏈€佺澶寸瓑锛屼负鍚庣画澶氫汉鍗忓悓涓庢寔涔呭寲棰勭暀鎺ュ彛
 */
  ...
  return (
    <div className={styles.stage} onDragOver={handleDragOver} onDrop={handleDropTemplate}>
      <Tldraw
        ...
        components={{
          // 鍙鐩?tldraw 榛樿 UI锛屼緥濡傞殣钘忛《閮ㄨ彍鍗曘€佷娇鐢ㄨ嚜瀹氫箟 Toolbar 绛?
        }}
      />
    </div>
  )
